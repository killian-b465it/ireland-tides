...
const FRESHWATER_SPOTS = [
  ...
  { id: 'lough_corrib', name: 'Lough Corrib', type: 'Lake', lat: 53.4167, lng: -9.1833, species: ['Brown Trout', 'Pike', 'Salmon', 'Perch'], licenseRequired: true, licenseType: 'Salmon/Sea Trout License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: "Ireland's largest lake. Famous mayfly hatches May-June." },
  ...
  { id: 'lough_conn', name: 'Lough Conn', type: 'Lake', lat: 53.95, lng: -9.53, species: ['Salmon', 'Brown Trout', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon/Sea Trout License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Best April-September.' },
  ...
  { id: 'lough_beltra', name: 'Lough Beltra', type: 'Lake', lat: 53.83, lng: -9.70, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Scenic Mayo lake.' },
  { id: 'lough_inagh', name: 'Lough Inagh', type: 'Lake', lat: 53.48, lng: -9.85, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Connemara. Part of Ballynahinch system.' },
  { id: 'kylemore_lough', name: 'Kylemore Lough', type: 'Lake', lat: 53.55, lng: -9.88, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'At base of Kylemore Abbey.' },
  { id: 'derryclare_lough', name: 'Derryclare Lough', type: 'Lake', lat: 53.48, lng: -9.82, species: ['Salmon', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Connemara scenic lake.' },
  ...
  { id: 'river_moy', name: 'River Moy', type: 'River', lat: 54.10, lng: -9.15, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License + Local Permit', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Top salmon river. Ridge Pool famous.' },
  { id: 'river_erriff', name: 'River Erriff', type: 'River', lat: 53.63, lng: -9.72, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Excellent spate river.' },
  { id: 'owenmore_river', name: 'Owenmore River', type: 'River', lat: 53.90, lng: -9.92, species: ['Salmon'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Mayo salmon fishery.' },

  // ===== MUNSTER (Kerry, Cork, Clare, Limerick, Tipperary, Waterford) =====
  { id: 'killarney_lakes', name: 'Killarney Lakes (Lough Leane)', type: 'Lake', lat: 52.02, lng: -9.52, species: ['Salmon', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Free fishing. Stunning scenery.' },
  ...
  { id: 'lough_currane', name: 'Lough Currane', type: 'Lake', lat: 51.82, lng: -10.15, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon/Sea Trout License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Waterville. World famous sea trout.' },
  ...
  { id: 'caragh_lake', name: 'Caragh Lake', type: 'Lake', lat: 52.00, lng: -9.87, species: ['Salmon', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Kerry gem.' },
  ...
  { id: 'river_shannon', name: 'River Shannon', type: 'River', lat: 52.67, lng: -8.63, species: ['Salmon', 'Brown Trout', 'Pike', 'Bream', 'Roach'], licenseRequired: true, licenseType: 'Salmon License (salmon only)', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: "Ireland's longest river." },
  { id: 'river_blackwater_munster', name: 'Munster Blackwater', type: 'River', lat: 52.13, lng: -8.00, species: ['Salmon', 'Brown Trout', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License + Permit', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'The Irish Rhine.' },
  { id: 'river_laune', name: 'River Laune', type: 'River', lat: 52.07, lng: -9.75, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Flows from Killarney Lakes.' },
  { id: 'river_feale', name: 'River Feale', type: 'River', lat: 52.45, lng: -9.40, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Kerry/Limerick border.' },
  { id: 'river_suir', name: 'River Suir', type: 'River', lat: 52.35, lng: -7.50, species: ['Salmon', 'Brown Trout', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Three Sisters river.' },
  { id: 'river_bandon', name: 'River Bandon', type: 'River', lat: 51.73, lng: -8.73, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Cork river.' },
  { id: 'river_lee', name: 'River Lee', type: 'River', lat: 51.90, lng: -8.90, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Flows through Cork city.' },

  // ===== LEINSTER (Dublin, Wicklow, Wexford, Carlow, Kilkenny, Laois, Offaly, Westmeath, Longford, Meath, Louth, Kildare) =====
  // Dublin Area
  { id: 'river_liffey', name: 'River Liffey', type: 'River', lat: 53.35, lng: -6.30, species: ['Brown Trout', 'Salmon', 'Sea Trout', 'Roach'], licenseRequired: true, licenseType: 'Salmon License (salmon only)', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Dublin. Free stretch at Islandbridge & above Leixlip.' },
  ...
  { id: 'river_boyne', name: 'River Boyne', type: 'River', lat: 53.72, lng: -6.35, species: ['Brown Trout', 'Salmon', 'Sea Trout', 'Bream', 'Roach'], licenseRequired: true, licenseType: 'Salmon License (salmon only)', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Premier trout fishery. Slane, Navan, Trim.' },
  { id: 'river_fane', name: 'River Fane', type: 'River', lat: 54.00, lng: -6.42, species: ['Brown Trout', 'Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Louth/Monaghan. Good wild brown trout.' },
  { id: 'river_dee', name: 'River Dee', type: 'River', lat: 53.95, lng: -6.55, species: ['Brown Trout', 'Salmon'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Louth. Runs to Ardee.' },
  { id: 'river_glyde', name: 'River Glyde', type: 'River', lat: 53.92, lng: -6.57, species: ['Brown Trout', 'Salmon'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Louth. Good brown trout.' },
  // Wicklow
  ...
  { id: 'river_slaney', name: 'River Slaney', type: 'River', lat: 52.67, lng: -6.55, species: ['Salmon', 'Brown Trout', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Wexford/Wicklow salmon river.' },
  { id: 'river_dargle', name: 'River Dargle', type: 'River', lat: 53.18, lng: -6.10, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Wicklow spate river.' },
  ...
  { id: 'river_nore', name: 'River Nore', type: 'River', lat: 52.65, lng: -7.25, species: ['Salmon', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Kilkenny. Three Sisters.' },

  // ===== ULSTER - Republic (Donegal, Cavan, Monaghan) =====
  { id: 'rosses_lakes', name: 'Rosses Lakes', type: 'Lake', lat: 54.95, lng: -8.35, species: ['Brown Trout', 'Sea Trout', 'Salmon'], licenseRequired: true, licenseType: 'Salmon License for salmon', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal. 130+ small lakes.' },
  ...
  { id: 'lough_eske', name: 'Lough Eske', type: 'Lake', lat: 54.72, lng: -8.02, species: ['Brown Trout', 'Salmon'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal. Near Donegal town.' },
  { id: 'lough_melvin', name: 'Lough Melvin', type: 'Lake', lat: 54.42, lng: -8.15, species: ['Brown Trout', 'Salmon', 'Gillaroo', 'Sonaghan'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Border lake. Unique trout varieties.' },
  ...
  { id: 'river_finn', name: 'River Finn', type: 'River', lat: 54.80, lng: -7.72, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal. Spring salmon.' },
  { id: 'river_drowes', name: 'River Drowes', type: 'River', lat: 54.47, lng: -8.25, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal/Leitrim. First salmon often here.' },
  { id: 'gweebarra_river', name: 'Gweebarra River', type: 'River', lat: 54.90, lng: -8.25, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal spate river.' },
  { id: 'owenea_river', name: 'Owenea River', type: 'River', lat: 54.77, lng: -8.37, species: ['Salmon', 'Sea Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Donegal spate river.' },
  ...
  { id: 'river_corrib', name: 'River Corrib', type: 'River', lat: 53.27, lng: -9.05, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License + Corrib Permit', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Galway city. Short but prolific salmon river. Famous weir pools.', country: 'IE' },
  ...
  { id: 'river_deel_limerick', name: 'River Deel', type: 'River', lat: 52.55, lng: -9.22, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Limerick/Mayo. Spring salmon. Spate river, best after rain.', country: 'IE' },
  { id: 'river_mulkear', name: 'River Mulkear', type: 'River', lat: 52.60, lng: -8.48, species: ['Salmon', 'Sea Trout', 'Brown Trout'], licenseRequired: true, licenseType: 'Salmon License + Local Permit', licenseUrl: 'https://fisheriesireland.ie/angling-licences/', notes: 'Limerick. Spring & summer salmon. Excellent wild trout.', country: 'IE' },
    ...
    try {
      ...
      if (state.authMode === 'login') {
        ...
        if (userData.active === false) {
          return alert('Your account has been deactivated. Please contact info@irishfishinghub.com if you believe this is a mistake.');
        }
  ...
  try {
    ...
    userRef.on('value', (snapshot) => {
      ...
      if (userData.active === false && !state.user.id.includes('_main_root')) {
        ...
        userRef.off('value');
        alert('Your account has been deactivated. Please contact info@irishfishinghub.com if you believe this is a mistake.');
        logout();
      } else {
  ...
  if (isMobile) {
    tourSteps = [
      ...
      },
      {
        ...
        intro: "You can click any pin on the map behind this tour to see real-time tides, weather, and fishing conditions for that exact location."
      },
      {
        title: "Map Layers 🗺️",
      ...
      <div style="background: var(--bg-card); border: 1px solid var(--border-glass); border-radius: 12px; padding: 20px; display: flex; flex-direction: column;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">
          ...
          <div style="display: flex; gap: 5px; align-items: center;">
            ...
            ${isMember ? 
              `<button class="btn btn-sm btn-primary" onclick="openClubHubModal('${c.id}')">View Club</button>` : 
              `<button class="btn btn-sm btn-outline" onclick="joinClub('${c.id}')">Join Club</button>`
            }
          </div>
        </div>
      </div>
